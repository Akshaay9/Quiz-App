...
app.post("/", async (req, res) => {
  ...
  const lastLeaderBoardGuy = sortedLeaderboardList[sortedLeaderboardList.length - 1]
 ...
 // if user alredy present
  const isUSerAlredyLeaderBoarded = sortedLeaderboardList.filter((ele) => ele.name == name && ele.avatar == avatar)
